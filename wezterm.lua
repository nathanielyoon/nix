...
config.keys = {
	...
	{ key = "Delete", mods = "ALT", action = act.ShowDebugOverlay },
	{ key = "a", mods = "ALT", action = act.ActivateCommandPalette },
	{ key = "s", mods = "ALT", action = act.QuickSelect },
	{ key = "d", mods = "ALT", action = act.ActivateCopyMode },
...
config.key_tables.search_mode = {
	...
	{ key = "f", mods = "ALT", action = act.CopyMode("CycleMatchType") },
